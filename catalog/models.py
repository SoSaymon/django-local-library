...
class Book(models.Model):
    title = models.CharField(max_length=200, help_text='Enter the title of the book (e.g. The Great Gatsby)')
...
class BookInstance(models.Model):
    ...
    imprint = models.CharField(max_length=200, help_text='Enter the book imprint (e.g. Penguin Classics)')
